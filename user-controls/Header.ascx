            ...
            <div class="col-lg-8 col-md-8">
                <ul class="top-info text-center text-md-left">
                    <li><i class="fas fa-map-marker-alt"></i>
                        <p class="info-text">9051 Roorkee Incorporate, INDIA</p>
                    </li>
                </ul>
            </div>
            <!--/ Top info end -->
                ...
                <div class="row align-items-center">
                    <div class="logo col-lg-3 text-center text-lg-left mb-3 mb-md-5 mb-lg-0">
                        <a class="d-block" href="/">
                            <img loading="lazy" src="https://DEMO.com/images/design.png" style="height:40px;" alt="Constra">
                        </a>
                    </div>
                    <!-- logo end -->
                            ...
                            <%--<li>
                                <div class="info-box">
                                    <div class="info-box-content">
                                        ...
                                        <p class="info-box-subtitle">(+9) 701-737-5408</p>
                                    </div>
                                </div>
                            </li>--%>
                            <li>
                                <div class="info-box">
                                    <div class="info-box-content">
                                        ...
                                        <p class="info-box-subtitle">ashwanik616@gmail.com</p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div id="navbar-collapse" class="collapse navbar-collapse">
                          ...
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="news-single.html">News Single</a></li>
                                ...
                                <li class="nav-item"><a class="nav-link" href="http://www.DEMO.com/post.aspx?cat=1">FINANCE</a></li>
                                <li class="nav-item"><a class="nav-link" href="http://www.DEMO.com/post.aspx?cat=2">GOLD</a></li>
                                <li class="nav-item"><a class="nav-link" href="http://www.DEMO.com/post.aspx?cat=3">CRYPTOCURRENCY</a></li>
